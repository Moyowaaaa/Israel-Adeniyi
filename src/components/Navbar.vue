  ...
  <div class="navbar">
    <div class="navbar--container">
      <div class="navbar--container__linkscontainer nav">
        <router-link to="/">
          <div class="link" id="nav-logo">ADENIYI</div>
        </router-link>
        ...
        <div class="navbar--container__sublinkscontainer menulinks">
          ...
          <a
            href="https://drive.google.com/file/d/1sa1wvqYCFL-2jceORYTHE8OmZWR6otb3/view"
            target="_blank"
          >
    ...
    <div class="fullScreenNav">
      <div
        class="fullScreenNav--logocontainer"
        id="logo"
        ...
        <div class="fullScreenNav--container__subContainer">
          <div class="fullscreen-links-container menu-link">
            ...
            <a
              ...
              id="resume"
            ></a>
            <div class="nav-menu-link link3" @click="openResume">RESUME</div>

            <!-- </a> -->
            <div class="fullscreenButton" @click="navigateToContactme">
              Get in touch
            </div>
          </div>
          ...
          <div class="fullscreen-social-container contacts">
            ...
            <a
              href="https://www.linkedin.com/in/israel-adeniyi-a11b56220"
              target="_blank"
            >
...
onMounted(() => {
  ...
  menuBodyTl
    ...
    .from(
      [".links", ".link1", ".link2", ".link3", ".fullscreenButton"],
      {
        opacity: 0,
        duration: 1.2,
        stagger: 0.2,
...
onMounted(() => {
  const navLinks = [...document.querySelectorAll((".nav-menu-link" || ".nav-menu-logo"))];
